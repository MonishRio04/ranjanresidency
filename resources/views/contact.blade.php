    ...
    <div class="container">
        ...
        <div class="mobile-column" style="display: flex; flex-wrap: wrap; gap: 60px;">
            <div style="flex: 1; min-width: 300px;">
                <div class="luxury-card" style="padding: 50px;">
                    <h3 style="margin-bottom: 40px; color: var(--text-main); font-size: 1.8rem; font-weight: 600;">Direct Contact</h3>
            ...
            <div style="flex: 1.5; min-width: 320px;">
                <div style="width: 100%; height: 100%; overflow: hidden; border: 1px solid #eeeeee; box-shadow: 0 15px 40px rgba(0,0,0,0.05); min-height: 500px;">
                    <iframe 
