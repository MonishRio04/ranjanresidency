    ...
    <div class="container">
        ...
        <div class="mobile-column" style="display: flex; flex-wrap: wrap; gap: 60px; align-items: center;">
            <div style="flex: 1; min-width: 320px; position: relative;">
                <img src="{{ asset('images/site/20260207060025_IMG_4849.JPG') }}" style="width: 100%; border-radius: 0; box-shadow: 0 15px 40px rgba(0,0,0,0.1);" alt="Ranjan Mahal Exterior">
            </div>
            <div style="flex: 1.2; min-width: 280px;">
                ...
                <p style="color: var(--text-main); margin-bottom: 25px; font-size: 1.1rem; line-height: 1.8;">
                    Ranjan Residency & Mahal is more than just a place to stay; it's a landmark of luxury and comfort in Poigai, Vellore. Strategically located on M.C. Road, we provide a sophisticated environment for both premium accommodation and special occasions.
                </p>
                <p style="color: var(--text-main); margin-bottom: 25px; font-size: 1.1rem; line-height: 1.8;">
                    Our residency offers well-appointed rooms with modern amenities, including a complimentary non-veg breakfast for all room guests. Coupled with our grand air-conditioned conference hall, we offer a complete package for medical visitors, tourists, and event guests alike.
                </p>
